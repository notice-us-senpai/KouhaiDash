...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { category_id: @calendar.category_id, google_calendar_id: @calendar.google_calendar_id, name: @calendar.name }
    end
  ...
  test "should update calendar" do
    patch :update, id: @calendar, calendar: { category_id: @calendar.category_id, google_calendar_id: @calendar.google_calendar_id, name: @calendar.name }
    assert_redirected_to calendar_path(assigns(:calendar))
  end
