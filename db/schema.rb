...
ActiveRecord::Schema.define(version: 20160729070732) do
  ...
  add_index "displays", ["category_id"], name: "index_displays_on_category_id"
  add_index "displays", ["google_account_id"], name: "index_displays_on_google_account_id"
